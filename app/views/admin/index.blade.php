                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href=""><i class="fa fa-angle-double-right"></i> Borrow</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right"></i> Return</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="">
                                <i class="fa fa-calendar"></i> <span>Request</span>
